...
const images = ['https://avt3.s3.amazonaws.com/u/1536229171-image.png', Video, image1, image2, image3, image4];
        ...
        return (
            <div>
                ...
                <section className={styles['main-content']}>
                    ...
                    <a href="https://github.com/treyhuffine/lightbox-react">Examples and Documentation on Github</a>

                    <footer className={styles['site-footer']}>
                        <span className={styles['site-footer-owner']}>
                            <a href="https://github.com/treyhuffine/lightbox-react">Lightbox React</a> is maintained by <a
                            href="https://github.com/treyhuffine"
                            >treyhuffine</a>.
                        </span>
                ...
                <a href="https://github.com/treyhuffine/lightbox-react">
                    <img
